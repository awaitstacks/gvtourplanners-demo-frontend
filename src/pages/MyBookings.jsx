...
//   // Cancel booking for traveller or full booking
...
//   // ---------- NEW: helper to decide showing Pay Balance (online) ----------
...
//     // Hide Pay Balance if ANY traveller is user-cancelled and NOT admin-cancelled
...
//         return "Booking Confirmed (Advance Received)";
//       if (item.payment?.balance?.paid)
//         return "Booking Confirmed (Balance Received)";
//     }

//     // Online booking flow
//     if (!item.payment?.advance?.paid) return "Awaiting Advance Payment";
//     if (item.payment?.advance?.paid && !item.payment?.advance?.paymentVerified)
//       return "Advance Paid - Pending Verification";
//     if (item.payment?.advance?.paid && !item.payment?.balance?.paid)
//       return "Advance Paid";
//     if (item.payment?.balance?.paid && !item.payment?.balance?.paymentVerified)
//       return "Balance Paid - Pending Verification";
//     if (item.payment?.balance?.paymentVerified) return "Booking Confirmed";
...
//                   <>
//                     {/* Pay Advance — unchanged */}
//                     {!item.cancelled.byTraveller &&
//                       !item.cancelled.byAdmin &&
//                       !item.payment?.advance?.paid && (
//                         <button
//                           onClick={() => bookingRazorpay(item._id, "advance")}
...
//                     {/* Pay Balance per traveller rules */}
...
//                         {/* Show cancel button only when not already cancelled by either side and advance is paid */}
